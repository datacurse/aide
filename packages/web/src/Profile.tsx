 ...
 *
 * The daemon has derived this since the commit run landed — `profile.ts`, 500-odd
...
export function ProfileOverlay({
  ...
  useEffect(() => {
    ...
    api
      ...
      // chat's profile in the new chat's overlay.
        ...
        <div className="min-h-0 flex-1 overflow-y-auto px-4 py-3">
          {error ? (
            ...
            <p className="font-sans text-xs leading-relaxed text-fg-dim">
              aide has no run log for this conversation, so there is nothing to measure. Chats held
              in the CLI or the VS Code extension show up in this list, and only the turns aide
              itself ran are recorded.
            </p>
          ) : (

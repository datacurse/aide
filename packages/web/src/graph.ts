 ...
 *
 * Sized to two lines of rail text — subject, then sha and age — because the only
 * place this is drawn is the foot of a 16rem column. It was 44 when the graph
 * had a pane of its own.
 */
